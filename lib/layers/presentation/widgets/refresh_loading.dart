...
/// [RefreshLoading] far enough to demonstrate that they want the app to
/// refresh. The returned [Future] must complete when the refresh operation is
/// finished.
///
/// Used by [RefreshLoading.onRefresh].
...
/// Used to configure how [RefreshLoading] can be triggered.
...
///
/// The trigger mode is configured by [RefreshLoading.triggerMode].
///
/// ## Troubleshooting
///
/// ### Refresh indicator does not show up
///
/// The [RefreshLoading] will appear if its scrollable descendant can be
/// overscrolled, i.e. if the scrollable's content is bigger than its viewport.
/// To ensure that the [RefreshLoading] will always appear, even if the
...
/// ```
///
/// A [RefreshLoading] can only be used with a vertical scroll view.
///
/// See also:
///
///  * <https://material.io/design/platform-guidance/android-swipe-to-refresh.html>
///  * [RefreshLoadingState], can be used to programmatically show the refresh indicator.
///  * [RefreshProgressIndicator], widget used by [RefreshLoading] to show
...
class RefreshLoading extends StatefulWidget {
  ...
  /// Defines how this [RefreshLoading] can be triggered when users overscroll.
  ///
  /// The [RefreshLoading] can be pulled out in two cases,
  ...
  @override
  RefreshLoadingState createState() => RefreshLoadingState();
}

/// Contains the state for a [RefreshLoading]. This class can be used to
/// programmatically show the refresh indicator, see the [show] method.
class RefreshLoadingState extends State<RefreshLoading> with TickerProviderStateMixin<RefreshLoading> {
  ...
  @override
  void didUpdateWidget(covariant RefreshLoading oldWidget) {
  ...
  ///
  /// Creating the [RefreshLoading] with a [GlobalKey<RefreshIndicatorState>]
  /// makes it possible to refer to the [RefreshLoadingState].
  ///
  /// The future returned from this method completes when the
  /// [RefreshLoading.onRefresh] callback's future completes.
  ///
